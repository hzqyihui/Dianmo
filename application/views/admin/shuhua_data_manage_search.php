...
<script type="text/javascript">
        ...
        if(temp){
                window.location.href='<?php echo site_url('admin/admin_post/shuhua_del').'/'?>'+id;
        }else{
        }
}
</script>
<body>
<br/>
<form name="user" method="post" action="<?php echo site_url('admin/admin_post/calli_reseach'); ?>">
	<div><input type="text" name="calli_name" class="seh" placeholder="输入书画作者查询">
...
<table width="100%" border="1" align="center" class="page_h">
  ...
  <tr>
    ...
    <td height="200" align="center"><?php echo str_replace($name,'<font color="#FF0000">'.$name.'</font>',$value['writer'])?></td>
    <td align="center"><div class="image"><img src="<?php $pic_path=$value['pic_path'];echo base_url($pic_path)?>" width="50%"></div></td>
    <td height="200" align="center"><?php echo $value['admire_num']?></td>
    <td align="center"><a href="#" onclick="del_alert(<?php echo $value['id']?>)">删除</a></td>
  </tr>
 <?php } ?>
  </table>
<!--<div id="div_001">
