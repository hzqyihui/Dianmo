...
<div id="div_001">
  ...
  <div>
  	...
  	<div class="div_5102_tr"><textarea readonly="readonly"rows='5'><?php $poem_name = $value['name'];echo str_replace($name,'<font color="#FF0000">'.$name.'</font>',$poem_name); ?></textarea></div>
  	<div class="div_5103_tr"><textarea readonly="readonly"rows='5'><?php echo str_replace($name,'<font color="#FF0000">'.$name.'</font>',$value['class']); ?></textarea></div>
  	<div class="div_5104_tr"><textarea readonly="readonly"rows='5'><?php echo str_replace($name,'<font color="#FF0000">'.$name.'</font>',$value['writer']); ?></textarea></div>
