...
<script type="text/javascript">
        ...
        if(temp){
                window.location.href='<?php echo site_url('admin/admin_post/comment_shuhua_del').'/'?>'+id;
        }else{
...
<body>
<br/>
<form name="user" method="post" action="<?php echo site_url('admin/admin_post/comment_calli_reseach'); ?>">
	<div>
		<input type="text" name="name" class="seh" placeholder="输入评论对象或者敏感词汇查询">
		<input type="hidden" name="class_name" value="comments_calli">
...
<div id="div_001">
  <div >
    ...
    <div class="div_4103_tr">评论对象id</div>
  ...
  <div>
  	...
  	<div class="div_4103_tr"><textarea readonly="readonly"><?php echo $value['object_id']; ?></textarea></div>
  	<div class="div_4104_tr"><textarea readonly="readonly" cols= '56'><?php echo str_replace($name,'<font color="#FF0000">'.$name.'</font>',$value['comment']); ?></textarea></div>
