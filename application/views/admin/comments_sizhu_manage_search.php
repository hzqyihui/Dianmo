...
<script type="text/javascript">
        ...
        if(temp){
                window.location.href='<?php echo site_url('admin/admin_post/comment_sizhu_del').'/'?>'+id;
        }else{
...
<form name="user" method="post" action="<?php echo site_url('admin/admin_post/comment_reseach'); ?>">
	<div>
		...
		<input type="hidden" name="class_name" value="comments_music">
...
<div id="div_001">
  ...
  <div>
  	...
  	<div class="div_4103_tr"><textarea readonly="readonly" cols= '15'><?php echo str_replace($name,'<font color="#FF0000">'.$name.'</font>',$value['object']); ?></textarea></div>
