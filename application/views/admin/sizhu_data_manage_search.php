...
<div id="div_001">
  ...
  <div>
  	...
  	<div class="div_1102_tr"><?php echo str_replace($name,'<font color="#FF0000">'.$name.'</font>',$value['music_name']); ?></div>
  	<div class="div_1103_tr"><?php echo str_replace($name,'<font color="#FF0000">'.$name.'</font>',$value['singer']); ?></div>
  	<div class="div_1104_tr"><?php echo str_replace($name,'<font color="#FF0000">'.$name.'</font>',$value['writer']); ?></div>
  	<div class="div_1105_tr"><?php echo str_replace($name,'<font color="#FF0000">'.$name.'</font>',$value['composer']); ?></div>
  	<div class="div_1107_tr"><?php echo str_replace($name,'<font color="#FF0000">'.$name.'</font>',$value['arranger']); ?></div>
