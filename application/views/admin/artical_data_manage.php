...
<form name="user" method="post" action="<?php echo site_url('admin/admin_post/artical_reseach'); ?>">
	<div><input type="text" name="artical_name" class="seh" placeholder="输入文章名字作者类别查询">
...
<div id="div_001">
  ...
  <div>
  	...
  	<div class="div_3102_tr"><?php echo $value['name']; ?></div>
  	<div class="div_3103_tr"><?php echo $value['writer']; ?></div>
  	<div class="div_3104_tr"><?php echo $value['artical']; ?>"</div>
  	<div class="div_3105_tr"><?php echo $value['class']; ?></div>
