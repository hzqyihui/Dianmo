...
<table width="100%" border="1" align="center" class="page_h">
  ...
  <tr>
    ...
    <td height="200" align="center"><?php echo str_replace($name,'<font color="#FF0000">'.$name.'</font>',$value['name'])?></td>
    <td align="center"><div class="image"><img src="<?php $pic_path=$value['pic_path'];echo base_url($pic_path)?>" width="50%"></div></td>
    <td height="200" align="center"><?php echo str_replace($name,'<font color="#FF0000">'.$name.'</font>',$value['class'])?></td>
