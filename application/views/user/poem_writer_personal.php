					...
					<div class="works">
						<table width="100%">
							<tbody>
								...
								<?php foreach($upload_poem as $upload_poem_list){  ?>
								<tr>
									<td class="songname">
										<cite>·</cite>
										<a href="<?php $s_id = $upload_poem_list['id']; echo site_url('/shici/get_out/shici_get').'/'.$s_id; ?>"><?php echo $upload_poem_list['name']; ?></a>
									</td>
									<td><?php echo $upload_poem_list['time']; ?></td>
								</tr>
								<?php }  ?>
