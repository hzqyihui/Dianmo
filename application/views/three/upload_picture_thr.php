...
<div class="main_pricture">
	...
	<div class="pricture_b">
		...
		<div class="big_pric">
			<img src="<?php $picpath = $detail_list['pic_path']; echo base_url($picpath); ?>" width="650px">
		</div>
	</div>
	<!-- 简介 -->
	<div class="introduce">
		<div class="fra">
			<div class="intro_m">
				...
				<h6>画师:</h6>
				<a href="<?php echo site_url('banner/to_other_personal').'/'.$detail_list['user_name']; ?>" class="p_name"><?php echo $detail_list['user_name']; ?></a>
			</div>
		</div>
	</div>
	<?php }  ?>
